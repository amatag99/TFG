...
figure(1)
Ec_horario=readmatrix('Perfiles.xlsx','sheet', 'Casa', 'Range', 'S2:S25');
G_horario=readmatrix('Perfiles.xlsx','sheet', 'Casa', 'Range', 'T2:T25');
g_horio=gini(Ec_horario, G_horario, true);
hold on

figure(2)
Ec_mes=readmatrix('Perfiles.xlsx','sheet', 'Casa', 'Range', 'H2:H13');
G_mes=readmatrix('Perfiles.xlsx','sheet', 'Casa', 'Range', 'I2:I13');
g_mes=gini(Ec_mes, G_mes, true);
